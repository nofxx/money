...
<<<<<<< HEAD:README.rdoc
- This fork: http://github.com/bobek/money
- Website: http://money.rubyforge.org
- RDoc API: http://money.rubyforge.org
- Forked from: http://github.com/ShadowBelmolve/money/tree
- Original git repository: http://github.com/FooBarWidget/money/tree/master
=======
- Website: http://money.rubyforge.org
- RDoc API: http://money.rubyforge.org
